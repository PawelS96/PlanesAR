...
public class VideoRenderer {
    private static final String LOGTAG = "VideoRenderer";

    private RenderingPrimitives mRenderingPrimitives = null;
    private final RendererControl mRenderingInterface;
    ...
    public VideoRenderer(RendererControl renderingInterface, Activity activity,
